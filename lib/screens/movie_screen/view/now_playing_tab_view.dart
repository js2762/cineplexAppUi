...
class NowPlayingTabView extends StatelessWidget {
  const NowPlayingTabView({super.key});
         ...
         Padding(
          ...
          child: Row(
            ...
            children: [
              InkWell(
                onTap: () {
                  Navigator.of(context).pushNamed(ChooseLocationScreenView.routeName);
                },
                child: const Row(
                  children: [
                    Icon(
               ...
               InkWell(
                 onTap: () {
                   Navigator.of(context).pushNamed(ChooseDateScreenView.routeName);
                 },
                 child: const Row(
                  children: [
                    Icon(
